...
export const CommonCodeModal: FC<ICommonCodeModalProps> = ({groupId, postSuccess, setGroupId}) => {
    ...
    const commonCodeDetail = async () => {
        ...
        // axios.post("/management/commonCodeDetailJson.do", {groupIdx: groupId}).then((res: AxiosResponse<{detailValue: ICommonCode}>) => {
        ...
        <CommonCodeModalStyle>
            <div className='container'>
                ...
                <div className={"button-container"}>
                    ...
                    {!!groupId && <button type='button' onClick={deleteCommonCode}>삭제</button>}                    
