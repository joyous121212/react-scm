...
export const DetailCodeMain = () => {
    ...
    const searchDetailCode = () => {
        axios.post("/management/commonDetailCodeListJson.do", {
            ...searchKeyword,
            ...
            console.log(res.data.commonDetailCode)
        });
    }
    ...
    return (
        <DetailCodeMainStyled>
            <table>
                ...
                <tbody>
                    {commonDetailCodeList?.length > 0 ? (commonDetailCodeList.map((commonDetailCode) => {
                        return( <tr key = {commonDetailCode.detailIdx}>
