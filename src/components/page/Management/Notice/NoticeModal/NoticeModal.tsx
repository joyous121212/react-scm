...
export const NoticeModal: FC<INoticeModalProps> = ({ noticeId, setNoticeId, postSuccess }) => {
    ...
    const saveNotice = () => {
        ...
        // console.log(formRef.current); // form 태그 전체가 들어감
    };
...
const saveNoticeFile = () => {
    ...
    const fileDownload = () => {
        ...
        axios.post("/management/noticeDownload.do", param, { responseType: "blob" }).then((res:AxiosResponse<Blob>) => {
        ...
        <NoticeModalStyled>
            <div className='container'>
                <form ref={formRef}>                    
                    ...
                    파일 :<StyledInput type='file' name='file' id='fileInput' style={{ display: "none" }} onChange={handlerFile}></StyledInput>
                    ...
                    <div className={"button-container"}>
                        ...
                        {!!noticeId &&<StyledButton type='button' onClick={noticeDeleteFile}>삭제</StyledButton>}
                        <StyledButton type='button' onClick={() => setModal(false)}>나가기</StyledButton>
                    </div>
                </form>
            </div>
        </NoticeModalStyled>
